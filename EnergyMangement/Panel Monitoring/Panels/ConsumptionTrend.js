...
const ConsumptionChart = ({ props ,id}) => {
  ...
  useLayoutEffect(() => {
    ...
    valueAxis.min = 0;
    // valueAxis.numberFormatter.numberFormat = "00.00";
    ...
    // series.tensionX=0.8
   series.stroke = am4core.color("#154734");
    series.fill = am4core.color("#154734"); 
  ...
  return (
    <div id={id} style={{ width: "100%", height: "150px" }}>
    </div>
  );
}
